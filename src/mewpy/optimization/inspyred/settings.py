...
OU = {"variators": [uniform_crossover_OU, grow_mutation_OU, shrink_mutation, single_mutation_OU]}

KO = {"variators": [uniform_crossover_KO, grow_mutation_KO, shrink_mutation, single_mutation_KO]}
